import 'package:apsc_100m3_724_f/screens/inventory.dart';
...
class MyScaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //AppBar starts here
    InventoryData databaseCaller = new InventoryData();
    databaseCaller.fetchItems();
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
                icon: Image.asset('lib/images/gear.png'),
                onPressed: () {
          ...
          leading: IconButton(
            icon: Image.asset('lib/images/app_swirl.png'),
            onPressed: () {},
          ),
